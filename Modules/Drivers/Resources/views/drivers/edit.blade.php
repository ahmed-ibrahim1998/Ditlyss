...
@section('title' , __('drivers::cruds.update-driver')  .' '. $driver->user->name)
    ...
    <div class="card card-custom">
        ...
        <span class="card-icon">
            <i class="fas fa-car"></i>
                ...
                <h3 class="card-label fw-bolder">@lang('drivers::cruds.update-driver') | {{$driver->user->name}}</h3>
            </div>
        ...
        <div class="card-body">
            ...
            <form class="form" id="driver_form" action="{{route('drivers.update' , $driver->id)}}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-md-12">
                        <div class="mb-10">
                            ...
                            <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url({{asset('/assets/media/avatars/blank.png')}})">
                                ...
                                <div class="image-input-wrapper w-125px h-125px" style="background-image: url({{$driver->profile_pic == NULL ? asset('media/images/drivers/blank.png' ) : asset('media/images/drivers/' . $driver->profile_pic) }})"></div>
                    ...
                    <div class="col-md-12">
                        <div class="mb-10">
                            ...
                            <input type="text" class="form-control form-control-solid @error('name')is-invalid @enderror" placeholder="@lang('drivers::cruds.name')" name="name" value="{{$driver->user->name}}"/>
                    ...
                    <div class="col-md-12">
                        <div class="mb-10">
                            ...
                            <input type="email" class="form-control form-control-solid @error('email')is-invalid @enderror" placeholder="@lang('drivers::cruds.email')" name="email" value="{{$driver->user->email}}"/>
                            ...
                            <div class="fv-row" data-kt-password-meter="true">
                                ...
                                <div class="mb-1">
                                    ...
                                    <label class="form-label fw-bold fs-6 mb-2">
                                        @lang('drivers::cruds.new-password')
                                    </label>
                                    <!--end::Label-->
                    ...
                    <div class="col-md-12">
                        <div class="mb-10">
                            ...
                            <input type="text" class="form-control form-control-solid @error('lat')is-invalid @enderror" placeholder="@lang('drivers::cruds.latitude')" name="lat" value="{{$driver->lat}}"/>
                    ...
                    <div class="col-md-12">
                        <div class="mb-10">
                            ...
                            <input type="text" class="form-control form-control-solid @error('long')is-invalid @enderror" placeholder="@lang('drivers::cruds.longitude')" name="long" value="{{$driver->long}}"/>
                    ...
                    <div class="col-md-12">
                        <div class="mb-10">
                            ...
                            <input type="text" class="form-control form-control-solid @error('subscription_type')is-invalid @enderror" placeholder="@lang('drivers::cruds.subscription-type')" name="subscription_type" value="{{$driver->subscription_type}}"/>
                    ...
                    <div class="col-md-12">
                        <div class="mb-10">
                            ...
                            <div class="position-relative w-md-300px"
                                ...
                                <!--begin::Input control-->
                                <input type="text" class="form-control form-control-solid border-0 ps-12 @error('subscription_value')is-invalid @enderror" data-kt-dialer-control="input" placeholder="Amount" name="subscription_value" value="{{$driver->subscription_value}}" />
                                <!--end::Input control-->
                        ...
                        <div class="mb-10">
                            ...
                            <select class="form-select form-select-solid @error('vehicle_id')is-invalid @enderror" data-control="select2" data-placeholder="Select a vehicle" name="vehicle_id">
                                ...
                                @foreach($vehicles as $vehicle)
                                    <option value="{{$vehicle->id}}" @if($vehicle->id == $driver->vehicle_id) selected @endif>{{$vehicle->plate_number}}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-12">
                        <div class="mb-10">
                            ...
                            <input type="text" class="form-control form-control-solid @error('civil_id')is-invalid @enderror" placeholder="@lang('drivers::cruds.civil-id')" name="civil_id" value="{{$driver->civil_id}}"/>

            ...
            <div class="card">
                ...
                <div class="card-header border-0 pt-6 mb-5">
                    ...
                    <div class="card-toolbar">
                        ...
                        <!--end::Search-->
                        <div class="ml-3">
                            <a class="btn btn-primary" href="{{route('cuisine.create')}}"><i class="fa fa-plus"></i>{{__('vendor::cruds.create')}}</a>
                        </div>
                    </div>
                    <!--end::Card toolbar-->
                </div>
                    ...
                    <div class="table-responsive mb-5">
                        <table class="table table-striped table-row-bordered gy-5 gs-7 border rounded" id="vendors_table">
                            ...
                            <tr class="fw-bold fs-6 text-gray-800 border-bottom-2 border-gray-300 bg-gray-200">
                                ...
                                <th class="text-capitalize">{{trans('vendor::cruds.cuisines.name')}}</th>
